...
return array(
    ...
    'properties' => array(
        'creator'        => env('EXCEL_PROPERTIES_CREATOR', 'Maatwebsite'),
        'lastModifiedBy' => env('EXCEL_PROPERTIES_LAST_MODIFIED', 'Maatwebsite'),
        'title'          => env('EXCEL_PROPERTIES_TITLE', 'Spreadsheet'),
        'description'    => env('EXCEL_PROPERTIES_DESCRIPTION', 'Default spreadsheet export'),
        'subject'        => env('EXCEL_PROPERTIES_SUBJECT', 'Spreadsheet export'),
        'keywords'       => env('EXCEL_PROPERTIES_KEYWORDS', 'maatwebsite, excel, export'),
        'category'       => env('EXCEL_PROPERTIES_CATEGORY', 'Excel'),
        'manager'        => env('EXCEL_PROPERTIES_MANAGER', 'Maatwebsite'),
        'company'        => env('EXCEL_PROPERTIES_COMPANY', 'Maatwebsite'),
    ),
